<?php
    ...
    class Pagination
    {
        ...
        private function generateHtml($page, $text = null)
        {
            ...
            $currentUri = preg_replace('~/pages/[0-9]+~', '', $currentUri);
         ...
         *
         * @param $currentPage - номер страницы для установки
         * @return void
         */
        ...
        {
            # Округляем в большую сторону, так как к примеру 10 / 3 даст 3.33,
            # и нужно показать четыре страницы, а не три.
